...
namespace DomainEventsTest.SharingContext.OnlyTestExecution
{
    public class Test01 : IClassFixture<GameStateFixture>
    {
        private readonly GameStateFixture _gameStateFixture;
        private readonly ITestOutputHelper _output;

        public Test01(GameStateFixture gameStateFixture, ITestOutputHelper output)
        {
